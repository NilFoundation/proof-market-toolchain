; ModuleID = '/mnt/d/gits/zkllvm/examples/poseidon.cpp'
source_filename = "/mnt/d/gits/zkllvm/examples/poseidon.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_poseidon.cpp, ptr null }]
...
; Function Attrs: circuit mustprogress uwtable
define dso_local <3 x field_pallasb> @_Z17poseidon_example1u13field_pallasbu13field_pallasbu13field_pallasb(field_pallasb %0, field_pallasb %1, field_pallasb %2) local_unnamed_addr #5 {
  %4 = add field_pallasb %0, %1
  %5 = insertelement <3 x field_pallasb> undef, field_pallasb %4, i32 0
  %6 = add field_pallasb %1, %2
  %7 = insertelement <3 x field_pallasb> %5, field_pallasb %6, i32 1
  %8 = mul field_pallasb %0, %2
  %9 = insertelement <3 x field_pallasb> %7, field_pallasb %8, i32 2
  %10 = tail call <3 x field_pallasb> @_ZN3nil7crypto36hashes8poseidonEDv3_u13field_pallasb(<3 x field_pallasb> %9)
  ret <3 x field_pallasb> %10
}

declare <3 x field_pallasb> @_ZN3nil7crypto36hashes8poseidonEDv3_u13field_pallasb(<3 x field_pallasb>) local_unnamed_addr #1

; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_poseidon.cpp() #0 section ".text.startup" {
...
attributes #5 = { circuit mustprogress uwtable "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
