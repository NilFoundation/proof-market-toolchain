; ModuleID = '/mnt/d/gits/zkllvm/examples/sha2-256.cpp'
source_filename = "/mnt/d/gits/zkllvm/examples/sha2-256.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_sha2_256.cpp, ptr null }]
...
define dso_local <2 x field_pallasb> @_Z14sha256_exampleDv2_u13field_pallasbS_(<2 x field_pallasb> %0, <2 x field_pallasb> %1) local_unnamed_addr #5 {
  %3 = tail call <2 x field_pallasb> @_ZN3nil7crypto36hashes6sha256EDv2_u13field_pallasbS2_(<2 x field_pallasb> %0, <2 x field_pallasb> %1)
  ret <2 x field_pallasb> %3
}

declare <2 x field_pallasb> @_ZN3nil7crypto36hashes6sha256EDv2_u13field_pallasbS2_(<2 x field_pallasb>, <2 x field_pallasb>) local_unnamed_addr #1

; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_sha2_256.cpp() #0 section ".text.startup" {
