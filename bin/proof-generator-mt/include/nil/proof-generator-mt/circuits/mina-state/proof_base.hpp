...
#include <nil/proof-generator-mt/circuits/mina-state/index_terms.hpp>
#include <nil/proof-generator-mt/circuits/mina-state/prepare_proof.hpp>
#include <nil/proof-generator-mt/circuits/mina-state/prepare_index.hpp>
#include <nil/proof-generator-mt/circuits/mina-state/prepare_component.hpp>

#include <nil/proof-generator-mt/detail/utils.hpp>
        ...
        namespace mina_state {
            ...
            void generate_proof_base(
                ...
                using component_type =
                    nil::actor_blueprint_mc::components::base_field<ArithmetizationType, curve_type, kimchi_params,
                                                                    commitment_params, batch_size, 0, 1, 2, 3, 4, 5, 6,
                ...
                std::array<nil::actor_blueprint_mc::components::kimchi_proof_base<BlueprintFieldType, kimchi_params>,
                           batch_size>
                    proofs;
                ...
                nil::actor_blueprint_mc::components::kimchi_verifier_index_base<curve_type, kimchi_params>
                    verifier_index;
