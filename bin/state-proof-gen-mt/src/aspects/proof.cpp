    ...
    namespace proof {
        namespace aspects {
            ...
            void proof::set_options(cli_options_type &cli) const {
                boost::program_options::options_description options("NIL 'Light-Client' State Proof Generator");
                // clang-format off
                options.add_options()
            ...
            std::string proof::input_circuit_string() const {
                return json_circuit;
            }

            std::string proof::input_public_params_string() const {
                return json_public_input;
            }

            std::string proof::output_file_string() const {
                return output_file;
            }
        }    // namespace aspects
    }        // namespace proof
