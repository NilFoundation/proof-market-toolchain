...
#include <nil/state-proof-gen-mt/structs_deserialization.hpp>
//
...
nil::actor::future<> proof_new(boost::json::value jv, boost::json::value jv_public_input, std::string output_file) {
    return nil::actor::async([&] {
        int proof_number = 0;
        if (proof_number == 0) {
            using curve_type = nil::crypto3::algebra::curves::pallas;
            ...
            nil::actor::proof_generate<component_type, BlueprintFieldType, ArithmetizationParams, hash_type, Lambda>(
